...
class ChatModel(object):
    def __init__(self, batch_size, max_iteration, num_word, embedding_dim):
    ...
    def encoder_decoder_graph(self, input_batch):
        ...
        with tf.variable_scope('encoder'):
            ...
            if isinstance(fw_final_state, LSTMStateTuple):
                ...
                encoder_final_state.set_shape([self.batch_size, self.encoder_rnn_state_size * 2])
        ...
        with tf.variable_scope('beam_inputs'):
            ...
            if isinstance(encoder_final_state, LSTMStateTuple):
                ...
                tiled_encoder_final_state = tile_batch(encoder_final_state, self.beam_width)
