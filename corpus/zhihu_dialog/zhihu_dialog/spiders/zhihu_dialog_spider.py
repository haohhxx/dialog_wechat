...
import scrapy
from zhihu_dialog.items import ZhihuDialogItem
import json
import os
import time
    ...
    def check_login(self, response):
        ...
        if 'msg' in js and js['msg'] == '登录成功':
            for url in self.start_urls:
                return [scrapy.FormRequest(url=post_url, formdata=post_data, headers=self.header,
